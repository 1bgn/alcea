                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 8),
                        AskWidget(text: controller.currentBlock.ask, number: controller.currentAsk.watch(context)+1),
                        SizedBox(height: 32),
                        Column(
                          children: controller.currentBlock.answers
                              .map(
                                (e) => Padding(
                                  ...
                                  child: AnswerWidget(text: e.answer,value: controller.currentAnswerValue(e),checkingMode: controller.checkingMode.value,isCorrect: controller.checkingMode.value?controller.checkAnswer(e):null,onChanged: (v){
                                      ...
                                      Expanded(
                                        child: CustomPrimaryButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            final canNextAsk = controller.nextScreen();
                                            if(!canNextAsk){
